...
namespace BusinessApplication.Migrations
{
    ...
    public partial class AddArticlesSeedData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Articles",
                columns: new[] { "Id", "ArticleNumber", "Name", "Price" },
                values: new object[,]
                {
                    { 1, "A00001", "Apple MacBook Pro", 2800.0 },
                    { 2, "A00002", "Google Pixel Fold", 1950.0 },
                    { 3, "A00003", "Samsung Galaxy Book Pro", 1800.0 },
                    { 4, "A00004", "Apple iPhone 15 Pro", 1200.0 },
                    { 5, "A00005", "Apple Polishing Cloth", 39.990000000000002 }
                });
        }
